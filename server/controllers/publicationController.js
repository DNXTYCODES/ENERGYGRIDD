...
export const createPublication = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    console.error("Error creating publication:", err.message); // Log the error
...
export const getAllPublications = asyncHandler(async (req, res) => {
  try {
    ...
    console.error("Error fetching publications:", err.message); // Log the error
...
export const getPublication = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    console.error("Error fetching publication:", err.message); // Log the error
...
export const updatePublication = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    console.error("Error updating publication:", err.message); // Log the error
    if (err.code === "P2025") {
      res.status(404).json({ error: "Publication not found" });
      return;
    }
...
export const deletePublication = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    console.error("Error deleting publication:", err.message); // Log the error
    if (err.code === "P2025") {
      res.status(404).json({ error: "Publication not found" });
      return;
    }
